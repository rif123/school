                                ...
                                <form role="form" id="form-permission">
                                    <div class="box-body">
                                        <div class="form-group hide">                                            
                                            ...
                                            <input type="text" name="permission_id" class="form-control" placeholder="Enter ..."/>
                                        </div>                                        
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="box box-success">
                                ...
                                <div class="box-body">
                                    <table id="dt-permission" class="table table-bordered table-hover">
                                        <thead>
                                            <tr>
