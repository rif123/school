                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="box box-success">                                
                                <!-- form start -->
                                <form role="form" id="form-label">
                                    <div class="box-body">
                                        <div class="form-group hide">                                            
                                            <label>Label Id</label>
                                            <input type="text" name="label_id" class="form-control" placeholder="Enter ..."/>
                                        </div>                                        
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="box box-success">
                                ...
                                <div class="box-body">
                                    <table id="dt-label" class="table table-bordered table-hover">
                                        <thead>
                                            <tr>
